                ...
                <form method="POST" action="{{ route('productos.update', $producto->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('sku') is-invalid @enderror" id="sku" name="sku" value="{{ old('sku', $producto->sku) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('descripcion_corta') is-invalid @enderror" id="descripcion_corta" name="descripcion_corta" value="{{ old('descripcion_corta', $producto->descripcion_corta) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('descripcion_larga') is-invalid @enderror" id="descripcion_larga" name="descripcion_larga" rows="4">{{ old('descripcion_larga', $producto->descripcion_larga) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($producto->imagen)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $producto->imagen) }}" alt="{{ $producto->nombre }}" class="thumb-lg rounded d-block">
                        </div>
                        @endif
                        ...
                        @error('imagen') <span class="text-danger small d-block">{{ $message }}</span> @enderror
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="precio_neto">Precio Neto</label>
                            <input type="number" step="0.01" min="0" class="form-control @error('precio_neto') is-invalid @enderror" id="precio_neto" name="precio_neto" value="{{ old('precio_neto', $producto->precio_neto) }}">
                            @error('precio_neto') <span class="text-danger small">{{ $message }}</span> @enderror
                            <small class="text-muted">Precio de venta actual (c/IVA): ${{ number_format($producto->precio_venta, 0, ',', '.') }}</small>
                        </div><!--end col-->
                    </div><!--end row-->
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" min="0" class="form-control @error('stock_actual') is-invalid @enderror" id="stock_actual" name="stock_actual" value="{{ old('stock_actual', $producto->stock_actual) }}">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" min="0" class="form-control @error('stock_minimo') is-invalid @enderror" id="stock_minimo" name="stock_minimo" value="{{ old('stock_minimo', $producto->stock_minimo) }}">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" min="0" class="form-control @error('stock_bajo') is-invalid @enderror" id="stock_bajo" name="stock_bajo" value="{{ old('stock_bajo', $producto->stock_bajo) }}">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" min="0" class="form-control @error('stock_alto') is-invalid @enderror" id="stock_alto" name="stock_alto" value="{{ old('stock_alto', $producto->stock_alto) }}">
